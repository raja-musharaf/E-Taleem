...
class APIWrapper{
    private let baseURLString = "http://etaleem.gov.pk/api/"
    ...
    ////////////////////////////
    func getMethodCall(lastKey:String)->APIMessage {
        let apiMessage = APIMessage()
        
        let completePath: String =  "\(Constants.baseURL)\(lastKey)"
        ...
        let task = session.dataTask(with: urlRequest){
            ...
            apiMessage.ResponseMessage = String(data: data!, encoding: .utf8)!
