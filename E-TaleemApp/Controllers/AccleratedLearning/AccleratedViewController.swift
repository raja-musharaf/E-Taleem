...
//
//  AccleratedViewController.swift
//  E-TaleemApp
//
...
import UIKit
import WebKit
class AccleratedViewController: UIViewController {

    @IBOutlet weak var webView: WKWebView!
    @IBOutlet weak var downVC: UIView!
    ...
    override func viewDidLoad() {
        ...
        let baseURL = "https://etaleem.gov.pk/accelerated-learning"
    ...
    override func viewDidLayoutSubviews() {
        ...
        //imgLogo.font = imgLogo.font.withSize(18)
...
//        imgBulb.frame = CGRect(x: 0, y: 0, width: 60, height: downVC.frame.height )
//        imgComingSoon.frame = CGRect(x: 0, y: 0, width: 90, height: 90)
    }
